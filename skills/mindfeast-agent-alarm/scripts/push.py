...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--composer", help="Wake-sound credit / by-line (POST /api/audio/meta composer; UI: Credit)")
    parser.add_argument("--audio-title", help="Wake-sound title (POST /api/audio/meta title; UI: Title)")
