...
description: Create print-ready educational materials (worksheets, copywork sheets, maps, flashcards, narration pages, nature-notebook pages, certificates) using HTML/WeasyPrint or SVG/Inkscape. Use this skill when the user asks to render homeschool materials intended for print, PDF, or static tablet reading. Do not use for MindFeast, unlock questions, or app slide packages; those belong to mindfeast-slide-builder.
---
